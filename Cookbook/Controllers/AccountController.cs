...
namespace Cookbook.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult FacebookLogin(string token)
        {
            ...
            try
            {
                var json = client.DownloadString(String.Format("http://server-33.apphb.com/api/NguoiDung/Get/{0}", id));
            ...
            catch
            {
                ...
                Account account = new Account("hacavx5ep", "979233898146936", "o_7oRkUzntjVxyzAZxAjDHQxYOY");
